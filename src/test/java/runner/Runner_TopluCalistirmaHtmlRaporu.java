...
//@ConfigurationParameter(key = Constants.PLUGIN_PROPERTY_NAME,value = "pretty, junit:target/xml-report/cucumber.xml")package runner;


public class Runner_TopluCalistirmaHtmlRaporu {
}
